...
import {Decrypt} from "../backened/aes";
  ...
  useEffect(() => {
    if (socket) {
      socket.on("getLatestMessage", (newMessage) => {
        ...
        console.log(newMessage.msg,'encrypt message');
        console.log(Decrypt(newMessage.msg),'Decrypt message');
        const { time, msg, name } = newMessage;
        setMessages([...allMessages, { time, msg: Decrypt(msg), name}]);
